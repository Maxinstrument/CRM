      ...
      <div class="grid grid-2" style="align-items:start">
        ...
        <div>
          ...
          <div class="card" style="margin-top:16px">
            ...
            <p class="muted" style="font-size:13.5px">Recount <b>Attempts</b> from the outreach actually logged: calls, voicemails, texts and emails. System notes like "Appointment scheduled" don't count, and a lead that reached an appointment counts as at least one attempt. It never lowers a number, so attempt counts that came in with a lead list are kept. Safe to run again any time.</p>
